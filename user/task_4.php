                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <?php $result = $DB->query("SELECT * FROM fourttask");
                           ...
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            <div class="<?php echo $item['status'] == "banned" ? "banned" : ""?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                <img src="<?php echo $item['img'];?>" alt="<?php echo $item['alt']?>" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                        <?php echo $item['name'];?>
                                        <small class="m-0 fw-300">
                                            <?php echo $item['profic'];?>
                                        </small>
                                    </h5>
                                    <a href="https://twitter.com/@myplaneticket" class="text-info fs-sm" target="_blank"><?php echo $item['email'];?></a>
