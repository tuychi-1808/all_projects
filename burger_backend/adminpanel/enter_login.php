...
if (isset($_POST['save_login']))
{
    ...
    {
    $query = "SELECT * FROM student_usertbl WHERE username = :username AND password = :password";
    ...
    if ($count > 0)
    {
        ...
        $sessionIdQuery = $conn->prepare('SELECT full_name FROM student_usertbl WHERE username = :username');
    ...
    <div class="card w-100 justify-content-center align-items-center d-flex "">
        ...
        <form method="post" class="w-100 justify-content-center form-control align-items-center flex-column r">
            ...
            <div class="d-flex justify-content-center">
                <button type="submit" name="save_login" class="btn btn-primary w-100">Войти</button>
            </div>
